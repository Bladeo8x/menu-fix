...
function ready() {
  ...
  //   NOTE: We need to fix the REMOVE button that its making dissapear the modal when we remove an Item.
  ...
  // var addToCartButtons = document.getElementById("shop-item-button");
